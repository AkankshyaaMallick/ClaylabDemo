...
const Impact = () => {
  return (
    <div className="relative flex flex-col items-center justify-center align-center gap-6 sm:gap-8 group">
      <Image
      ...
      <section className="max-w-full sm:max-w-screen m-auto py-8 sm:py-16 px-2 sm:px-4 flex flex-col items-center text-center gap-4 sm:gap-6 absolute">
        ...
        {/* Paragraph constrained width */}
        <p className="text-sm sm:text-base md:text-lg text-[#2D2D2D] max-w-3xl mx-auto leading-relaxed">
          For Academic Year 2026-27, we are seeking school partners, from suburban
          or rural parts of Haryana and Uttarakhand, who are ready to collaborate
          with us for the implementation of the School of Entrepreneurship program
          in their schools. <br />
          <span className="font-bold text-green-600">
            Drop us an email
          </span> and we will connect with you and take it forward.
        </p>
        ...
        <a
          ...
          className="mt-4 flex items-center gap-2 bg-gradient-to-r from-[#2E9C4B] to-[#76E293] text-white font-medium px-4 sm:px-6 py-2 rounded-full shadow-md transition-all duration-300 text-sm sm:text-base hover:scale-105"
        >
